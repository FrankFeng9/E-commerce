    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/orders')?'active':'' }}  ">
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'confirmed-orders')? 'active':'' }}"><a href="{{ route('confirmed-orders') }}"><i class="ti-more"></i>View Orders</a></li>
                </ul>
            </li>
            @else
            @endif
            ...
            <li class="treeview {{ ($prefix == '/reports')?'active':'' }}  ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'all-charts')? 'active':'' }}"><a href="{{ route('all-charts') }}"><i class="ti-more"></i>Sales Charts</a></li>
                </ul>
            </li>
            @else
            @endif
