                    ...
                    <div class="module-body">
                        <ul class="toggle-footer clearfix" style="">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body"> <span style="Color:white"><a href="mailto:Support@bestchoice.com">Support@bestchoice.com</a></span> </div>
                            </li>
                        </ul>
                    </div>
                    <!-- /.module-body -->
...
<div class="kefu_wrap">
    <img src="{{ asset('img/kefu_float.png') }}" class="kefu_icon" onclick="window.open('{{ route('chat_test') }}', 'chat', 'top=50,left=100,width=600,height=600')"></div>
</div>
